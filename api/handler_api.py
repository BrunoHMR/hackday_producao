...
def costa_del_data_predict():
    ...
    if test_json:  # se o dado chegou
        ...
        test_raw = pd.DataFrame(test_json, columns=test_json['id',
                                                             'Classificação do hotel',
                                                             'Meses da reserva até o check-in',
                                                             'Número de pernoites reservadas',
                                                             'Número de hospedes,Regime de alimentação',
                                                             'Nacionalidade',
                                                             'Forma de Reserva',
                                                             ...
                                                             'Reserva com Observações'])  # keys: pega todas as linhas do dicionário
